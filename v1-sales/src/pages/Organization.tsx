...
const Organization = () => {
  ...
  const { getLabel, organization, user } = useOrganization();
  ...
  return (
    <>
      <Helmet>
        <title>Organization Management | DataViz Pro</title>
        <meta name="description" content="Manage your organization settings and structure" />
      </Helmet>

      <AppLayout>
        <div className="p-6 space-y-6">
          <div>
            <h1 className="text-3xl font-bold">{getLabel('organization.title')}</h1>
