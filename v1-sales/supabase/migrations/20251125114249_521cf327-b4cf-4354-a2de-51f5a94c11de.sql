...
CREATE POLICY "Users can view their own conversations"
  ...
  FOR SELECT
  USING (user_id = auth.uid() AND organization_id IN (
...
-- Add trigger for ai_conversations
...
CREATE INDEX idx_ai_conversations_organization_id ON public.ai_conversations(organization_id);
